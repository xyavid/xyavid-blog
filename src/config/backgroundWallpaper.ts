...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	 ...
	 *
	 * 这里用 "none"：本站走的是「卡片 + 主题色」的干净路线，不放头部大图。
	 * 想换成横幅只需改回 "banner"，并在下方 src 里指向一张真实存在的图片
	 * （Firefly 示例配置里引用的 DesktopWallpaper/d1-d6、MobileWallpaper/m1-m6
	 *   在上游仓库里并没有随附，直接沿用会得到一组 404 的图片请求）。
	 */
	mode: "none",
